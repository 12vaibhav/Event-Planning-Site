            ...
            <div className="lg:col-span-9">
                ...
                >
                  ...
                  <h1 className="font-serif italic text-brand-gold leading-[0.6] md:leading-[0.65] tracking-tight font-extrabold md:font-bold text-center md:text-left drop-shadow-[0_2px_4px_rgba(0,0,0,0.5)]">
                    ...
                    <motion.div variants={{ hidden: { opacity: 0, y: 30 }, visible: { opacity: 1, y: 0, transition: { duration: 1.5, ease: [0.22, 1, 0.36, 1] } } }} className="text-5xl md:text-9xl lg:text-10xl md:pl-24 drop-shadow-[0_2px_8px_rgba(0,0,0,0.4)] md:drop-shadow-[0_2px_6px_rgba(0,0,0,0.4)] mb-0 md:mb-0 font-black md:font-extrabold [-webkit-text-stroke:0.2px_white] md:[-webkit-text-stroke:0.5px_rgba(255,255,255,0.6)] lg:[-webkit-text-stroke:0.5px_rgba(255,255,255,0.5)] text-brand-maroon">
                      Shaadi
                    </motion.div>
                    ...
                    <motion.div variants={{ hidden: { opacity: 0, y: 30 }, visible: { opacity: 1, y: 0, transition: { duration: 1.5, ease: [0.22, 1, 0.36, 1] } } }} className="text-5xl md:text-9xl lg:text-10xl md:pl-48 drop-shadow-[0_2px_8px_rgba(0,0,0,0.4)] md:drop-shadow-[0_2px_6px_rgba(0,0,0,0.4)] mb-0 md:mb-0 font-black md:font-extrabold [-webkit-text-stroke:0.2px_white] md:[-webkit-text-stroke:0.5px_rgba(255,255,255,0.6)] lg:[-webkit-text-stroke:0.5px_rgba(255,255,255,0.5)] text-brand-maroon">
                      Mehndi
                    </motion.div>
